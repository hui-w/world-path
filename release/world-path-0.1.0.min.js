/* world-path v0.1.0 | https://github.com/hui-w/world-path */var Consts={KeyIndex:0,CountryIndex:1,LatLonIndex:4,LabelIndex:5,LevelIndex:6},Config={keyboard:{changeUnit:40,timerDelay:50},Toolbar:{navUnit:20,navTimerDelay:50,zoomTimerDelay:100,marginTop:16,marginLeft:8,marginRight:8,marginBottom:16,buttonSpacing:8,buttonPadding:8,buttonSize:48},WorldMap:{maxScale:30,minScale:.5,moveTimerDelay:50,moveDuration:800,zoomTimerDelay:50},colors:"#37C719 #E66C0F #D5312C #1B2258 #E62760 #3051EA".split(" "),colorIndex:0};
(function(a){if("replaceState"in history)a.replaceHash=function(c){"#"!==(""+c).charAt(0)&&(c="#"+c);history.replaceState("","",c)};else{var b=location.hash;a.replaceHash=function(c){location.hash!==b&&history.back();location.hash=c}}})(window);
var Util={$:function(){for(var a=[],b=0;b<arguments.length;b++){var c=arguments[b];"string"==typeof c&&(c=document.getElementById(c));if(1==arguments.length)return c;a.push(c)}return a},getQueryStringByName:function(a,b){null==b&&(b=location.search);a=b.match(new RegExp("[?&]"+a+"=([^&]+)","i"));return null==a||1>a.length?null:a[1]},setUrlHash:function(a,b){var c=window.location.hash;if(0>=c.length)window.location.hash=a+"="+b;else{var d=a+"=([^&]+)",e=c.match(new RegExp(d,"i"));a=null==e||1>e.length?
c+"&"+a+"="+b:c.replace(new RegExp(d,"i"),a+"="+b);history.replaceState(void 0,void 0,a)}},getUrlHash:function(a,b){null==b&&(b=window.location.hash);a=b.match(new RegExp("[#&]"+a+"=([^&]+)","i"));return null==a||1>a.length?null:a[1]},isNull:function(a){return"undefined"==a||null==a},is:function(a,b){b=String.prototype.toLowerCase.call(b);return"finite"==b?isFinite(a):"array"==b&&(a instanceof Array||Array.isArray&&Array.isArray(a))?!0:"null"==b&&null===a||b==typeof a&&null!==a||"object"==b&&a===
Object(a)||Object.prototype.toString.call(a).slice(8,-1).toLowerCase()==b},format_str:function(){var a=/\{([^\}]+)\}/g,b=/(?:(?:^|\.)(.+?)(?=\[|\.|$|\()|\[('|")(.+?)\2\])(\(\))?/g,c=function(d,e,f){var g=f;e.replace(b,function(n,k,m,p,l){k=k||p;g&&(k in g&&(g=g[k]),"function"==typeof g&&l&&(g=g()))});return g=(null==g||g==f?d:g)+""};return function(d,e){return String(d).replace(a,function(f,g){return c(f,g,e)})}}()},Browser={versions:function(){var a=navigator.userAgent;return{trident:-1<a.indexOf("Trident"),
presto:-1<a.indexOf("Presto"),webKit:-1<a.indexOf("AppleWebKit"),gecko:-1<a.indexOf("Gecko")&&-1==a.indexOf("KHTML"),mobile:!!a.match(/AppleWebKit.*Mobile.*/),ios:!!a.match(/\(i[^;]+;( U;)? CPU.+Mac OS X/),android:-1<a.indexOf("Android")||-1<a.indexOf("Linux"),iPhone:-1<a.indexOf("iPhone"),iPad:-1<a.indexOf("iPad"),webApp:-1==a.indexOf("Safari")}}(),language:(navigator.browserLanguage||navigator.language).toLowerCase()};
Element.prototype.attr=function(a,b){if(!a){if(1!=this.nodeType)return{text:this.nodeValue};for(var c=this.attributes,d={},e=0,f=c.length;e<f;e++)d[c[e].nodeName]=c[e].nodeValue;return d}if(Util.is(a,"string"))if(1<arguments.length)c={},c[a]=b,a=c;else return this.getAttribute(a);for(d in a)a.hasOwnProperty(d)&&this.setAttribute(d,a[d]);return this};
Element.prototype.createChildNS=function(a,b,c,d){a=document.createElementNS("http://www.w3.org/2000/svg",a);d&&this.hasChildNodes()?this.insertBefore(a,this.firstChild):this.appendChild(a);if(b)for(var e in b)a.setAttribute(e,b[e]);c&&(a.textContent=c);return a};Element.prototype.getStyle=function(a){var b=this.getAttribute("style");if(null!=b&&0<b.trim().length){b=b.split(";");for(var c=0;c<b.length&&0<b[c].trim().length;c++){var d=b[c].split(":");if(2==d.length&&a==d[0].trim())return d[1].trim()}}return null};
Element.prototype.updateStyle=function(a,b){var c=this.getAttribute("style"),d=!1,e="";if(null!=c&&0<c.trim().length){c=c.split(";");for(var f=0;f<c.length&&0<c[f].trim().length;f++){var g=c[f].split(":");2==g.length&&(a==g[0].trim()?(d=!0,null!=b&&(e+=a+": "+b+"; ")):e+=g[0].trim()+": "+g[1].trim()+"; ")}}d||(e+=a+": "+b+"; ");this.setAttribute("style",e)};Array.prototype.each=function(a,b){b=this.findItem(b);for(var c=0;c<b.length;c++)"function"==typeof a&&a.call(b[c])};
String.prototype.format=function(){var a=arguments;return this.replace(/\{(\d+)\}/g,function(b,c){return a[c]})};function Frame(a,b,c,d){this.map=a;this.map.frame=this;this.width=b;this.height=c;this.toolbar=null;if(this.fullscreen=d)this.width=document.documentElement.clientWidth,this.height=document.documentElement.clientHeight;this.statusLabel=this.frameObj=null;this.isHolding=!1;this.mousePoint={x:-1,y:-1};this.startDistance=-1;this.arrowKeyStatus=0;this.keyboardTimer=null;this.inMotion=!1}
Frame.prototype={moveMapTo:function(a,b,c){var d=this;if(!this.inMotion){this.inMotion=!0;var e=Config.WorldMap.moveDuration/Config.WorldMap.moveTimerDelay,f=Math.round((a-this.map.left)/e),g=Math.round((b-this.map.top)/e),n=function(){if(d.map.left==a&&d.map.top==b)d.inMotion=!1,"function"==typeof c&&c();else{var k=d.map.left+f,m=d.map.top+g;if(0==f||0<f&&k>a||0>f&&k<a)k=a;if(0==g||0<g&&m>b||0>g&&m<b)m=b;d.map.moveTo(k,m,null);setTimeout(n,Config.WorldMap.moveTimerDelay)}};n()}},scaleMapTo:function(a,
b){var c=this;if(!this.inMotion){this.inMotion=!0;a<Config.WorldMap.minScale?a=Config.WorldMap.minScale:a>Config.WorldMap.maxScale&&(a=Config.WorldMap.maxScale);var d=a>this.map.scale?1.1:.9,e=function(){if(c.map.scale==a)c.inMotion=!1,"function"==typeof b&&b();else{var f=c.map.scale*d;if(1>d&&f<a||1<d&&f>a)f=a;var g=c.convertFramePointToMap(c.width/2,c.height/2);c.map.zoomTo(f,g);setTimeout(e,Config.WorldMap.zoomTimerDelay)}};e()}},setCenterAndScale:function(a,b,c,d){var e=this;this.scaleMapTo(1,
function(){e.setCenterPoint(a,b,!0,function(){e.scaleMapTo(c,function(){"function"==typeof d&&d()})})})},setCenterPoint:function(a,b,c,d){a=this.width/2-a*this.map.scale;b=this.height/2-b*this.map.scale;c?this.moveMapTo(a,b,d):(this.map.moveTo(a,b),"function"==typeof d&&d())},getCenterPoint:function(){return{cx:(this.width/2-this.map.left)/this.map.scale,cy:(this.height/2-this.map.top)/this.map.scale}},renderInto:function(a,b){var c=this;this.frameObj=document.createElement("div");var d=Util.format_str("width: {width}px; height: {height}px; cursor: pointer; overflow: hidden; border: none; background-color: RGBA(100, 100, 100, 0.2);",
{width:this.width,height:this.height});this.frameObj.setAttribute("style",d);a.appendChild(this.frameObj);this.toolbar=new Toolbar(this);this.map.renderInto(this.frameObj,function(){c.enableInteractive();c.toolbar.renderInto(c.map.getExtraGroup());c.statusLabel=c.map.getExtraGroup().createChildNS("text",{fill:"#666",class:"no-select",x:4,y:10,"font-size":8});var f=Util.getUrlHash("cx"),g=Util.getUrlHash("cy"),n=Util.getUrlHash("s");null!=f&&null!=g?c.setCenterPoint(f,g,!1,function(){if(null!=n){var k=
c.convertFramePointToMap(c.width/2,c.height/2);c.map.zoomTo(n,k)}}):(c.setCenterPoint(c.map.width/2,c.map.height/2,!1,null),c.updateStatusLabel());f=Util.getUrlHash("r");g=Util.getUrlHash("f");0==f&&c.toolbar.showRoutes(!1);0==g&&c.toolbar.showFlights(!1);"function"==typeof b&&b()});this.toolbar.onZoom=function(f){var g=c.convertFramePointToMap(c.width/2,c.height/2);return c.map.zoom(f,g)};this.toolbar.onZoomRestore=function(){c.scaleMapTo(1,null)};this.toolbar.onNavigate=function(f,g){c.map.move(f,
g)};this.toolbar.onNaviRestore=function(){c.setCenterPoint(c.map.width/2,c.map.height/2,!0,null)};this.map.onScaleChanged=function(){c.updateStatusLabel()};this.map.onPositionChanged=function(){c.updateStatusLabel()};if(this.fullscreen){var e=function(){c.map.resize(c.width,c.height);c.toolbar.adjustPosition(c.width,c.height)};setInterval(function(f){f=document.documentElement.clientWidth;var g=document.documentElement.clientHeight;if(f!=c.width||g!=c.height)c.width=f,c.height=g,c.frameObj.style.width=
c.width+"px",c.frameObj.style.height=c.height+"px",e()},200);e()}else this.toolbar.adjustPosition(this.width,this.height)},updateStatusLabel:function(){this.statusLabel.textContent="[{0}, {1}] x {2}".format(this.map.left.toFixed(1),this.map.top.toFixed(1),this.map.scale.toFixed(1));var a=this.getCenterPoint();Util.setUrlHash("cx",a.cx.toFixed(3));Util.setUrlHash("cy",a.cy.toFixed(3));Util.setUrlHash("s",this.map.scale.toFixed(3))},enableInteractive:function(){var a=this;this.handleTouchEvent=function(b){if(!a.inMotion)switch(b.preventDefault(),
b.type){case "touchstart":if(1==b.touches.length)a.eventDown(b.targetTouches[0]);else if(2==b.touches.length){var c=b.targetTouches[0];b=b.targetTouches[1];a.startDistance=a.getDistance(c.pageX,c.pageY,b.pageX,b.pageY)}break;case "touchmove":1==b.changedTouches.length?a.eventMove(b.changedTouches[0]):2==b.touches.length&&(c=b.targetTouches[0],b=b.targetTouches[1],c=a.getDistance(c.pageX,c.pageY,b.pageX,b.pageY),a.map.zoom(c>a.startDistance?1:-1),a.startDistance=c);break;case "touchend":1==b.changedTouches.length&&
a.eventUp(b.changedTouches[0])}};this.frameObj.addEventListener("touchstart",this.handleTouchEvent,!1);this.frameObj.addEventListener("touchend",this.handleTouchEvent,!1);this.frameObj.addEventListener("touchmove",this.handleTouchEvent,!1);this.handleMouseEvent=function(b){if(!a.inMotion)switch(b.preventDefault(),b.type){case "mousedown":a.eventDown(b);break;case "mousemove":a.eventMove(b);break;case "mouseup":a.eventUp(b);break;case "mouseleave":a.isHolding=!1;break;case "mousewheel":var c=a.getEventPositionOnMap(b,
a.frameObj);a.map.zoom(0<b.wheelDelta?1.1:.9,c)}};this.frameObj.addEventListener("mousedown",this.handleMouseEvent,!1);this.frameObj.addEventListener("mousemove",this.handleMouseEvent,!1);this.frameObj.addEventListener("mouseup",this.handleMouseEvent,!1);this.frameObj.addEventListener("mouseleave",this.handleMouseEvent,!1);this.frameObj.addEventListener("dblclick",this.handleMouseEvent,!1);this.frameObj.addEventListener("mousewheel",this.handleMouseEvent,!1);this.handleKeyEvent=function(b){a.inMotion||
a.handleKey(b,a)};document.addEventListener("keydown",this.handleKeyEvent,!1);document.addEventListener("keyup",this.handleKeyEvent,!1)},eventDown:function(a){this.isHolding=!0;this.mousePoint.x=a.pageX;this.mousePoint.y=a.pageY},eventUp:function(a){this.isHolding=!1},eventMove:function(a){!this.isHolding||void 0!=a.layerX&&(Browser.versions.iPhone||Browser.versions.iPad)||(this.map.move(a.pageX-this.mousePoint.x,a.pageY-this.mousePoint.y),this.mousePoint.x=a.pageX,this.mousePoint.y=a.pageY)},handleKey:function(a){var b=
this,c=a.keyCode;switch(a.type){case "keydown":var d=function(){var e=Config.keyboard.changeUnit,f=0,g=0;0<(b.arrowKeyStatus&1)&&(f+=e);0<(b.arrowKeyStatus&2)&&(g+=e);0<(b.arrowKeyStatus&4)&&(f-=e);0<(b.arrowKeyStatus&8)&&(g-=e);0<b.arrowKeyStatus?(b.map.move(f,g),b.keyboardTimer=setTimeout(d,Config.keyboard.timerDelay)):b.keyboardTimer=null};switch(c){case 37:case 65:this.arrowKeyStatus|=1;break;case 38:case 87:this.arrowKeyStatus|=2;break;case 39:case 68:this.arrowKeyStatus|=4;break;case 40:case 83:this.arrowKeyStatus|=
8}0<this.arrowKeyStatus&&null==this.keyboardTimer&&d();break;case "keyup":switch(c){case 37:case 65:b.arrowKeyStatus&=-2;break;case 38:case 87:b.arrowKeyStatus&=-3;break;case 39:case 68:b.arrowKeyStatus&=-5;break;case 40:case 83:b.arrowKeyStatus&=-9}0==b.arrowKeyStatus&&null!=b.keyboardTimer&&(clearTimeout(b.keyboardTimer),b.keyboardTimer=null)}},getDistance:function(a,b,c,d){return-1*Math.sqrt((c-a)*(c-a)+(d-b)*(d-b))},getEventPositionOnMap:function(a){return{x:a.pageX-this.frameObj.offsetLeft-this.map.left,
y:a.pageY-this.frameObj.offsetTop-this.map.top}},convertFramePointToMap:function(a,b){return{x:a-this.frameObj.offsetLeft-this.map.left,y:b-this.frameObj.offsetLeft-this.map.top}},home:function(){var a=this.map.getPoiPosition("SHA");this.setCenterAndScale(a.x,a.y,Config.WorldMap.maxScale,function(){console.log("DONE")})},addCustomButton:function(a,b,c,d){this.toolbar&&this.toolbar.renderCustomButton(a,b,c,d)}};
function WorldMap(){this.parent=this.frame=null;this.width=1E3;this.height=400;this.scale=1;this.top=this.left=0;this.onPositionChanged=this.onScaleChanged=this.extraGroup=this.mapGroup=this.svg=null}
WorldMap.prototype={renderInto:function(a,b){this.parent=a;this.svg=this.parent.createChildNS("svg",{id:"svg",width:this.width,height:this.height});this.mapGroup=this.svg.createChildNS("g");this.extraGroup=this.svg.createChildNS("g");this.renderCountries(this.mapGroup);this.renderFlightsAndRoutes(this.mapGroup);this.renderPois(this.mapGroup);"function"==typeof b&&b()},resize:function(a,b){this.svg.style.width=a+"px";this.svg.style.height=b+"px";this.svg.attr("width",a);this.svg.attr("height",b)},
getExtraGroup:function(){return this.extraGroup},updateTransform:function(){this.mapGroup.attr({transform:Util.format_str("translate({left}, {top}) scale({scale}, {scale})",{left:this.left,top:this.top,scale:this.scale})});for(var a=this.mapGroup.querySelectorAll("path.country"),b=0;b<a.length;b++)a[b].attr("stroke-width",1/this.scale);b=this.mapGroup.querySelector("path.border");b.attr("stroke-width",1/this.scale);b.attr("stroke-dasharray",Util.format_str("{size},{size}",{size:5/this.scale}));a=
this.mapGroup.querySelectorAll("circle.poi-circle");for(b=0;b<a.length;b++){var c=1/this.scale*4;1>this.scale&&(c/=2);a[b].attr("r",c)}a=this.mapGroup.querySelectorAll("text.poi-label");for(b=0;b<a.length;b++){c=a[b];var d=c.attr("data-level");Util.isNull(d)&&(d=0);this.scale>=d?("none"==c.getStyle("display")&&c.updateStyle("display",""),c.attr("font-size",1/this.scale*12)):"none"!=c.getStyle("display")&&c.updateStyle("display","none")}a=this.mapGroup.querySelectorAll("path.route, path.flight");for(b=
0;b<a.length;b++)a[b].attr("stroke-width",1/this.scale),null!=a[b].attr("stroke-dasharray")&&a[b].attr("stroke-dasharray","{0},{0}".format(2/this.scale))},renderCountries:function(a){for(var b in worldmap.shapes)a.createChildNS("path",{d:worldmap.shapes[b],stroke:"#333333",fill:"#f0efeb","stroke-opacity":.6,"stroke-width":1,class:"country"});this.renderGhostCountry(this.mapGroup,"US",this.width);this.renderGhostCountry(this.mapGroup,"CA",this.width);this.renderGhostCountry(this.mapGroup,"CN",-this.width);
this.renderGhostCountry(this.mapGroup,"TW",-this.width);a.createChildNS("path",{d:Util.format_str("M0,0 H{width} V{height} H0 Z",{width:this.width,height:this.height}),stroke:"#000000",fill:"none","stroke-width":1,"stroke-opacity":.2,"stroke-dasharray":"5,5",class:"border"})},renderGhostCountry:function(a,b,c){var d=this;a=a.createChildNS("path",{d:worldmap.shapes[b],stroke:"RGBA(127,127,127, 0.4)",fill:"RGBA(255,255,255,0.1)","stroke-opacity":.6,"stroke-width":1,class:"country",transform:Util.format_str("translate({left},0)",
{left:c})});var e=function(){d.frame.moveMapTo(d.left+c*d.scale,d.top,null)};a.addEventListener("mousedown",function(){e()},!1);a.addEventListener("touchstart",function(){e()},!1)},renderPois:function(a){var b=this;window.mapdata.pois.forEach(function(c){b.renderPoi(a,c,0);"ORD"!=c[Consts.KeyIndex]&&"LAX"!=c[Consts.KeyIndex]&&"SFO"!=c[Consts.KeyIndex]&&"YVR"!=c[Consts.KeyIndex]&&"JFK"!=c[Consts.KeyIndex]||b.renderPoi(a,c,b.width);"SHA"==c[Consts.KeyIndex]&&b.renderPoi(a,c,-b.width)})},renderPoi:function(a,
b,c){var d=b[Consts.LabelIndex],e=b[Consts.LevelIndex],f=this.parseLatLon(b[Consts.LatLonIndex]);b=f.x;f=f.y;null!=c&&0!=c&&(b+=c);a.createChildNS("circle",{cx:b,cy:f,r:0,fill:"#E66C0F",stroke:"none",class:"poi-circle"});a.createChildNS("text",{x:b,y:f,fill:"#000000",stroke:"none","font-size":1/this.scale*12,class:"poi-label",style:"display: none","data-level":e},d)},getControlPoint:function(a,b,c,d){var e=(a.x+b.x)/2;b=(a.y+b.y)/2;var f=Math.sqrt(Math.pow(a.x-e,2)+Math.pow(a.y-b,2));c*=f;var g={x:(a.y-
b)*c/f+e,y:(e-a.x)*c/f+b};a={x:(b-a.y)*c/f+e,y:(a.x-e)*c/f+b};return 0<Math.atan2(g.y-b,g.x-e)*d?g:a},drawFlightLine:function(a,b,c,d){0==d?(this.drawFlightLine(a,b,c,-1),this.drawFlightLine(a,b,c,1)):(d=this.getControlPoint(b,c,.6,d),a.createChildNS("path",{d:Util.format_str("M{from.x},{from.y} Q{control.x},{control.y} {to.x},{to.y}",{from:{x:b.x,y:b.y},control:{x:d.x,y:d.y},to:{x:c.x,y:c.y}}),fill:"none",stroke:Config.colors[Config.colorIndex%Config.colors.length],"stroke-width":1,class:"flight"}))},
renderFlight:function(a,b,c,d,e){b=this.getPoiPosition(b);c=this.getPoiPosition(c);d?(d={x:b.x>c.x?b.x-this.width:this.width+b.x,y:b.y},this.drawFlightLine(a,b,{x:b.x>c.x?this.width+c.x:c.x-this.width,y:c.y},e),this.drawFlightLine(a,d,c,e)):this.drawFlightLine(a,b,c,e)},renderRouteGroup:function(a,b){var c=this,d="";b.forEach(function(e){e=0<e.indexOf(",")?c.parseLatLon(e):c.getPoiPosition(e);d=0<d.length?d+" L{0},{1}".format(e.x,e.y):d+"M{0},{1}".format(e.x,e.y)});a.createChildNS("path",{d:d,fill:"none",
stroke:"#ff0000","stroke-width":1,"stroke-dasharray":"2,2",class:"route"})},renderFlightsAndRoutes:function(a){var b=this;window.mapdata.flights.forEach(function(c){c.forEach(function(d){b.renderFlight(a,d[0],d[1],d[2],d[3])});window.mapdata.colorIndex++});window.mapdata.routes.forEach(function(c){b.renderRouteGroup(a,c)})},zoom:function(a,b){if(this.scale<Config.WorldMap.minScale&&1>a||this.scale>Config.WorldMap.maxScale&&1<a)return!1;var c=b.x*(1-a);b=b.y*(1-a);this.scale*=a;this.move(c,b)||this.updateTransform();
if("function"==typeof this.onScaleChanged)this.onScaleChanged();return!0},zoomTo:function(a,b){return this.zoom(a/this.scale,b)},move:function(a,b){if(0==a&&0==b)return!1;this.moveTo(this.left+a,this.top+b,null);return!0},moveTo:function(a,b){this.left=a;this.top=b;this.updateTransform();if("function"==typeof this.onPositionChanged)this.onPositionChanged()},showFlights:function(a){for(var b=this.mapGroup.querySelectorAll("path.flight"),c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")},
showRoutes:function(a){for(var b=this.mapGroup.querySelectorAll("path.route"),c=0;c<b.length;c++)b[c].updateStyle("display",a?null:"none")},getPoi:function(a){for(var b=0;b<window.mapdata.pois.length;b++)if(window.mapdata.pois[b][Consts.KeyIndex]==a)return window.mapdata.pois[b];return null},getPoiPosition:function(a){a=this.getPoi(a);return null!=a?this.parseLatLon(a[Consts.LatLonIndex]):{x:0,y:0}},getXY:function(a,b){return{x:2.6938*b+465.4,y:-2.6938*a+227.066}},getLatLon:function(a,b){return{lat:(b-
227.066)/-2.6938,lon:(a-465.4)/2.6938}},parseLatLon:function(a){var b=(a=String(a).split(/(\d+(?:\.\d+)?)[\xb0\s]?\s*(?:(\d+(?:\.\d+)?)['\u2019\u2032\s])?\s*(?:(\d+(?:\.\d+)?)["\u201d\u2033\s])?\s*([SNEW])?/i))&&+a[1]+(a[2]||0)/60+(a[3]||0)/3600;"S"==a[4].toUpperCase()&&(b=-b);var c=a&&+a[6]+(a[7]||0)/60+(a[8]||0)/3600;"W"==a[9].toUpperCase()&&(c=-c);return this.getXY(b,c)},getScreenCeterPointOnMap:function(){console.log(this.parent.width)}};
function Toolbar(a){this.frame=a;this.zoomRatio=0;this.naviSpeed={x:0,y:0};this.buttonCount=0;this.flightOverlay=this.routesOverlay=this.onNaviRestore=this.onNavigate=this.onZoomRestore=this.onZoom=this.onZoomOut=this.onZoomIn=this.naviGroup=this.toolSub=this.toolGroup=this.scaleGroup=null}
Toolbar.prototype={renderInto:function(a){var b=this;this.scaleGroup=a.createChildNS("g");var c=Util.format_str("M0,{center} H{iconSize} M{center},0 V{iconSize}",{center:(Config.Toolbar.buttonSize-2*Config.Toolbar.buttonPadding)/2,iconSize:Config.Toolbar.buttonSize-2*Config.Toolbar.buttonPadding});this.renderButton(this.scaleGroup,0,0,c,!0,!1,!1,function(d){b.zoomRatio=1.1;b.startZoomTimer()},function(d){b.zoomRatio=1});c=Util.format_str("M0,{center} H{iconSize}",{center:(Config.Toolbar.buttonSize-
2*Config.Toolbar.buttonPadding)/2,iconSize:Config.Toolbar.buttonSize-2*Config.Toolbar.buttonPadding});this.renderButton(this.scaleGroup,1,0,c,!0,!1,!1,function(d){b.zoomRatio=.9;b.startZoomTimer()},function(d){b.zoomRatio=1});this.toolGroup=a.createChildNS("g");this.renderButton(this.toolGroup,0,0,"M8,0 L24,16 L8,32",!0,!1,!1,function(d,e,f){null==b.toolSub.getStyle("display")?(b.toolSub.updateStyle("display","none"),e.attr("d","M8,0 L24,16 L8,32")):(b.toolSub.updateStyle("display",null),e.attr("d",
"M24,0 L8,16 L24,32"))},null);this.toolSub=this.toolGroup.createChildNS("g",{transform:"translate({0}, {1})".format(Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing,0),style:"display: none"});this.renderButton(this.toolSub,0,0,"M0,16 H10 M14,16 H18 M22,16 H32 M16,0 V10 M16,22 V32",!0,!1,!1,function(d){if("function"==typeof b.onNaviRestore)b.onNaviRestore()},null);this.renderButton(this.toolSub,0,1,"M4,6 V26 M16,8 V12 M16,24 V20 M28,6 V26",!0,!1,!1,function(d){if("function"==typeof b.onZoomRestore)b.onZoomRestore()},
null);this.flightOverlay=this.renderButton(this.toolSub,0,2,"M29.532,17.258c-0.584-0.985-3.159-2.277-3.602-2.488L18.155,9.53L17.53,2.608C17.438,2.172,16.903,0,15.561,0c-1.376,0-1.833,2.097-1.89,2.394l-0.699,7.468l-7.103,4.973c-0.473,0.243-2.86,1.496-3.396,2.431c-0.482,0.843-0.373,3.24-0.346,3.712c0.01,0.179,0.104,0.342,0.253,0.439c0.15,0.097,0.334,0.118,0.503,0.058l10.24-3.797l0.898,9.151c0,0.112,0.001,0.223,0.006,0.332c-0.91,0.464-2.98,1.59-3.463,2.501c-0.227,0.435-0.134,1.352-0.059,1.859c0.026,0.165,0.122,0.311,0.265,0.396C10.858,31.972,10.959,32,11.062,32c0.063,0,0.124-0.011,0.183-0.031l3.503-1.208h1.621l3.593,1.131c0.159,0.047,0.328,0.029,0.467-0.06c0.14-0.088,0.236-0.231,0.26-0.393c0.083-0.554,0.141-1.291-0.061-1.67c-0.527-0.975-2.805-2.152-3.796-2.629l1.165-9.719l11.15,3.674c0.165,0.055,0.349,0.03,0.495-0.071c0.145-0.099,0.235-0.261,0.243-0.437C29.912,19.992,29.97,17.994,29.532,17.258z M17.845,16.188c-0.055-0.02-0.115-0.029-0.176-0.029h-0.156c-0.285,0-0.525,0.213-0.558,0.496l-1.248,10.443c0,0.097-0.011,0.192-0.028,0.286c-0.043,0.252,0.088,0.501,0.321,0.606c1.318,0.605,3.317,1.722,3.622,2.279c0.017,0.055,0.021,0.181,0.017,0.34l-3.013-0.948c-0.054-0.017-0.111-0.026-0.168-0.026h-1.803c-0.062,0-0.124,0.012-0.183,0.03l-2.92,1.008c-0.012-0.236-0.01-0.426,0.008-0.488c0.287-0.543,2.102-1.604,3.298-2.184c0.212-0.103,0.337-0.326,0.315-0.563c-0.02-0.196-0.025-0.401-
!1,!0,!0,function(d,e,f){b.showRoutes("none"==f.attr("stroke"))},null).overlay;this.renderButton(this.toolSub,1,0,"M16,0 L32,16 H28 V32 H20 V20 H12 V32 H4 V16 H0 Z",!0,!1,!1,function(d){b.frame.home()},null);this.naviGroup=a.createChildNS("g");this.renderButton(this.naviGroup,1,0,"M8,16 L20,24 V8 Z",!0,!1,!1,function(d){b.naviSpeed.x=Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.x=0});this.renderButton(this.naviGroup,0,1,"M16,8 L8,20 H24 Z",!0,!1,!1,function(d){b.naviSpeed.y=
Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.y=0});this.renderButton(this.naviGroup,1,2,"M24,16 L12,8 V24 Z",!0,!1,!1,function(d){b.naviSpeed.x=-Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.x=0});this.renderButton(this.naviGroup,1,1,"M16,24 L24,12 H8 Z",!0,!1,!1,function(d){b.naviSpeed.y=-Config.Toolbar.navUnit;b.startNaviTimer()},function(d){b.naviSpeed.y=0})},renderCustomButton:function(a,b,c,d){if(this.toolSub){var e=this,f=++this.buttonCount;this.renderButton(this.toolSub,
1,f,a,!0,!1,!1,function(g){e.frame.setCenterAndScale(b,c,d,null)},null)}},showRoutes:function(a){this.frame.map.showRoutes(a);this.routesOverlay.attr("stroke",a?"#333":"none");Util.setUrlHash("r",a?1:0)},showFlights:function(a){this.frame.map.showFlights(a);this.flightOverlay.attr("stroke",a?"#333":"none");Util.setUrlHash("f",a?1:0)},adjustPosition:function(a,b){this.scaleGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:a-Config.Toolbar.marginRight-Config.Toolbar.buttonSize,
top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}));this.toolGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:Config.Toolbar.marginLeft,top:Config.Toolbar.marginTop}));this.naviGroup.attr("transform",Util.format_str("translate({left}, {top})",{left:Config.Toolbar.marginLeft,top:b-Config.Toolbar.marginBottom-(2*Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)}))},renderButton:function(a,b,c,d,e,f,g,n,k){var m=this;a=a.createChildNS("g",
{transform:"translate({0}, {1})".format((Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)*c,(Config.Toolbar.buttonSize+Config.Toolbar.buttonSpacing)*b)});var p=a.createChildNS("path",{fill:f?"RGBA(0,0,0,1)":"none",stroke:e?"RGBA(0,0,0,1)":"none","stroke-width":4,"stroke-linejoin":"round",d:d,transform:"translate({0}, {0})".format(Config.Toolbar.buttonPadding)}),l=a.createChildNS("rect",{fill:"RGBA(255,255,255,0.4)",stroke:g?"#333":"none","stroke-width":1,x:0,y:0,rx:Config.Toolbar.buttonSize/
8,ry:Config.Toolbar.buttonSize/8,width:Config.Toolbar.buttonSize,height:Config.Toolbar.buttonSize});l.addEventListener("touchstart",function(h){h.preventDefault();m.highlightIcon(this.parentNode.childNodes[0],!0);"function"==typeof n&&n(h,p,l);h.stopPropagation()},!0);l.addEventListener("touchend",function(h){h.preventDefault();m.highlightIcon(this.parentNode.childNodes[0],!1);"function"==typeof k&&k(h,p,l);h.stopPropagation()},!0);l.addEventListener("touchcancel",function(h){h.preventDefault();m.highlightIcon(this.parentNode.childNodes[0],
!1);"function"==typeof k&&k(h,p,l);h.stopPropagation()},!0);l.addEventListener("touchmove",function(h){h.preventDefault();h.stopPropagation()},!0);l.addEventListener("mousedown",function(h){m.highlightIcon(this.parentNode.childNodes[0],!0);"function"==typeof n&&n(h,p,l);h.stopPropagation()},!0);l.addEventListener("mouseup",function(h){m.highlightIcon(this.parentNode.childNodes[0],!1);"function"==typeof k&&k(h,p,l);h.stopPropagation()},!0);l.addEventListener("mouseout",function(h){m.highlightIcon(this.parentNode.childNodes[0],
!1);"function"==typeof k&&k(h,p,l);h.stopPropagation()},!0);l.addEventListener("mousemove",function(h){h.stopPropagation()},!0);return{icon:p,overlay:l}},startZoomTimer:function(){var a=this,b=function(){1!=a.zoomRatio&&"function"==typeof a.onZoom&&a.onZoom(a.zoomRatio)&&setTimeout(b,Config.Toolbar.zoomTimerDelay)};b()},startNaviTimer:function(){var a=this,b=function(){0==a.naviSpeed.x&&0==a.naviSpeed.y||"function"!=typeof a.onZoom||(a.onNavigate(a.naviSpeed.x,a.naviSpeed.y),setTimeout(b,Config.Toolbar.navTimerDelay))};
b()},highlightIcon:function(a,b){"none"!=a.attr("stroke")&&a.attr("stroke",b?"#ff0000":"#000000");"none"!=a.attr("fill")&&a.attr("fill",b?"#ff0000":"#000000")}};
var worldmap={shapes:{AE:"M604.196,161.643l0.514-0.129l0,0.772l2.188-0.386l2.189,0l1.672,0.129l1.803-1.802l2.058-1.802l1.674-1.673l0.518,0.900l0.385,2.189l-1.417,0l-0.258,1.802l0.517,0.386l-1.159,0.515l-0.129,1.029l-0.773,1.159l0,1.030l-0.514,0.644l-8.110-1.416l-1.031-2.704l0.127,0.643z",AF:"M630.069,130.876l2.832,1.030l2.059-0.257l0.517-1.288l2.058-0.386l1.546-0.772l0.515-2.188l2.317-0.516l0.387-1.030l1.285,0.774l0.902,0.128l1.416,0l2.059,0.515l0.773,0.385l2.059-0.900l0.901,0.515l0.773-1.287l1.674,0.128l0.386-0.387l0.256-1.157l1.160-0.903l1.543,0.645l-0.384,0.772l0.901,0.129l-0.259,2.317l1.030,0.900l0.904-0.643l1.285-0.257l1.674-1.159l1.802,0.129l2.832,0l0.387,0.773l-1.545,0.385l-1.416,0.516l-3.090,0.256l-2.833,0.517l-1.545,1.287l0.645,1.029l0.257,1.416l-1.287,1.159l0.129,1.029l-0.773,0.902l-2.575,0l1.030,1.673l-1.673,0.772l-1.158,1.545l0.129,1.674l-1.031,0.772l-1.029-0.257l-2.061,0.386l-0.257,0.644l-2.058,0l-1.417,1.544l-0.129,2.317l-3.476,1.159l-1.931-0.257l-0.514,0.643l-1.674-0.386l-2.704,0.386l-4.504-1.415l2.445-2.447l-0.129-1.673l-2.060-0.515l-0.256-1
CN:"China",CO:"Colombia",CR:"Costa Rica",CU:"Cuba",CY:"Cyprus",CZ:"Czech Republic",DE:"Germany",DJ:"Djibouti",DK:"Denmark",DO:"Dominican Republic",DZ:"Algeria",EC:"Ecuador",EE:"Estonia",EG:"Egypt",EH:"Western Sahara",ER:"Eritrea",ES:"Spain",ET:"Ethiopia",FI:"Finland",FJ:"Fiji",FK:"Falkland Islands (Malvinas)",FR:"France",GA:"Gabon",GB:"United Kingdom",GE:"Georgia",GF:"French Guiana",GH:"Ghana",GL:"Greenland",GM:"Gambia",GN:"Guinea",GQ:"Equatorial Guinea",GR:"Greece",GT:"Guatemala",GW:"Guinea-Bissau",
GY:"Guyana",HN:"Honduras",HR:"Croatia",HT:"Haiti",HU:"Hungary",ID:"Indonesia",IE:"Ireland",IL:"Israel",IN:"India",IQ:"Iraq",IR:"Islamic Republic of Iran",IS:"Iceland",IT:"Italy",JM:"Jamaica",JO:"Jordan",JP:"Japan",KE:"Kenya",KG:"Kyrgyzstan",KH:"Cambodia",KP:"Democratic People\u2019s Republic of Korea",KR:"Republic of Korea",KW:"Kuwait",KZ:"Kazakhstan",LA:"Lao People\u2019s Democratic Republic",LB:"Lebanon",LK:"Sri Lanka",LR:"Liberia",LS:"Lesotho",LT:"Lithuania",LU:"Luxembourg",LV:"Latvia",LY:"Libyan Arab Jamahiriya",
MA:"Morocco",MD:"Republic of Moldova",MG:"Madagascar",MK:"The Former Yugoslav Republic of Macedonia",ML:"Mali",MM:"Myanmar",MN:"Mongolia",MR:"Mauritania",MW:"Malawi",MX:"Mexico",MY:"Malaysia",MZ:"Mozambique",NA:"Namibia",NC:"New Caledonia",NE:"Niger",NG:"Nigeria",NI:"Nicaragua",NL:"Netherlands",NO:"Norway",NP:"Nepal",NZ:"New Zealand",OM:"Oman",PA:"Panama",PE:"Peru",PG:"Papua New Guinea",PH:"Philippines",PK:"Pakistan",PL:"Poland",PR:"Puerto Rico",PS:"Occupied Palestinian Territory",PT:"Portugal",PY:"Paraguay",
QA:"Qatar",RO:"Romania",RS:"Serbia",RU:"Russian Federation",RW:"Rwanda",SA:"Saudi Arabia",SB:"Solomon Islands",SD:"Sudan",SE:"Sweden",SJ:"Svalbard and Jan Mayen",SK:"Slovakia",SL:"Sierra Leone",SN:"Senegal",SO:"Somalia",SR:"Suriname",SV:"El Salvador",SY:"Syrian Arab Republic",SZ:"Swaziland",TD:"Chad",TG:"Togo",TH:"Thailand",TJ:"Tajikistan",TL:"Timor-Leste",TM:"Turkmenistan",TN:"Tunisia",TR:"Turkey",TW:"Province of China Taiwan",TZ:"United Republic of Tanzania",UA:"Ukraine",UG:"Uganda",US:"United States",
UY:"Uruguay",UZ:"Uzbekistan",VE:"Bolivarian Republic of Venezuela",VN:"Viet Nam",VU:"Vanuatu",YE:"Yemen",ZA:"South Africa",ZM:"Zambia",ZW:"Zimbabwe"}};
