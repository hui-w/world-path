...
Toolbar.prototype = {
    ...
    renderInto: function(parent) {
        ...
        this.renderButton(this.scaleGroup, 0, 0, iconPlus, true, false, false,
            function(e) {
                that.zoomRatio = 1.1;
                that.startZoomTimer();
            },
        ...
        this.renderButton(this.scaleGroup, 1, 0, iconMinus, true, false, false,
            function(e) {
                that.zoomRatio = 0.9;
                that.startZoomTimer();
            },
        ...
        this.renderButton(this.toolGroup, 0, 0, pathRight, true, false, false, function(e, icon, overlay) {
        ...
        //restore position
        this.renderButton(this.toolSub, 0, 0, "M0,16 H10 M14,16 H18 M22,16 H32 M16,0 V10 M16,22 V32", true, false, false, function(e) {
        ...
        //restore scale
        this.renderButton(this.toolSub, 0, 1, "M4,6 V26 M16,8 V12 M16,24 V20 M28,6 V26", true, false, false, function(e) {
        ...
        this.flightOverlay = this.renderButton(this.toolSub, 0, 2, flightsIconData, false, true, true, function(e, icon, overlay) {
        ...
        this.routesOverlay = this.renderButton(this.toolSub, 0, 3, routesIconData, false, true, true, function(e, icon, overlay) {
            that.showRoutes(overlay.attr("stroke") == "none");
        }, null).overlay;

        //home button
        this.renderButton(this.toolSub, 1, 0, "M16,0 L32,16 H28 V32 H20 V20 H12 V32 H4 V16 H0 Z", true, false, false, function(e) {
            that.frame.home();
        }, null);

        //navigation buttons
        this.naviGroup = parent.createChildNS("g");
        this.renderButton(this.naviGroup, 1, 0, "M8,16 L20,24 V8 Z", true, false, false, function(e) {
                //left
        ...
        this.renderButton(this.naviGroup, 0, 1, "M16,8 L8,20 H24 Z", true, false, false, function(e) {
                //top
        ...
        this.renderButton(this.naviGroup, 1, 2, "M24,16 L12,8 V24 Z", true, false, false, function(e) {
                //right
                that.naviSpeed.x = -Config.Toolbar.navUnit;
                that.startNaviTimer();
            },
        ...
        this.renderButton(this.naviGroup, 1, 1, "M16,24 L24,12 H8 Z", true, false, false, function(e) {
                //bottom
                that.naviSpeed.y = -Config.Toolbar.navUnit;
                that.startNaviTimer();
            },
    ...
    renderCustomButton: function(svgPath, targetCx, targetCy, targetScale) {
        ...
        this.renderButton(this.toolSub, 1, column, svgPath, true, false, false, function(e) {
    ...
    adjustPosition: function(width, height) {
        //scale bottons
        this.scaleGroup.attr("transform", Util.format_str("translate({left}, {top})", {
        ...
        //tool buttons
        this.toolGroup.attr("transform", Util.format_str("translate({left}, {top})", {
        ...
        //navigation buttons
        this.naviGroup.attr("transform", Util.format_str("translate({left}, {top})", {
